...
class ModernBackpropGUI:
    def __init__(self, root):
        ...
        self.lbl_aturan.grid(row=4, column=0, columnspan=2, padx=5, pady=(8, 0), sticky="w")
        ...
        for epoch in range(1, max_epoch + 1):
            ...
            for i in range(len(X)):
                ...
                for j in range(4):
                    ...
                    self.txt_log.insert(tk.END, f"    z{j+1}: Dv1{j+1}={dv1:.6f}, Dv2{j+1}={dv2:.6f}, DV0{j+1}={dv0:.6f}\n")
